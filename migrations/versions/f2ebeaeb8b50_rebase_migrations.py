...
Revision ID: f2ebeaeb8b50
Revises:
Create Date: 2024-09-27 12:05:44.474576
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("local_plan", "reference"),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column("local_plan_document_local_plan", sa.Text(), nullable=False),
        sa.Column("organisation", sa.Text(), nullable=False),
        sa.ForeignKeyConstraint(
