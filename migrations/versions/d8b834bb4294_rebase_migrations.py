...
def upgrade():
    ...
    sa.Enum('TIMETABLE_PUBLISHED', 'ESTIMATED_REGULATION_18', 'ESTIMATED_REGULATION_19', 'ESTIMATED_EXAMINATION_AND_ADOPTION', 'REGULATION_18', 'REGULATION_19', 'PLANNING_INSPECTORATE_EXAMINATION', 'PLANNING_INSPECTORATE_FINDINGS', name='eventcategory').create(op.get_bind())
    sa.Enum('FOR_REVIEW', 'FOR_PLATFORM', 'NOT_FOR_PLATFORM', 'EXPORTED', name='status').create(op.get_bind())
    ...
    sa.Column('event_category', postgresql.ENUM('TIMETABLE_PUBLISHED', 'ESTIMATED_REGULATION_18', 'ESTIMATED_REGULATION_19', 'ESTIMATED_EXAMINATION_AND_ADOPTION', 'REGULATION_18', 'REGULATION_19', 'PLANNING_INSPECTORATE_EXAMINATION', 'PLANNING_INSPECTORATE_FINDINGS', name='eventcategory', create_type=False), nullable=True),
    sa.Column('reference', sa.Text(), nullable=False),
    sa.Column('name', sa.Text(), nullable=True),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('entry_date', sa.Date(), nullable=False),
    ...
    sa.Column('status', postgresql.ENUM('FOR_REVIEW', 'FOR_PLATFORM', 'NOT_FOR_PLATFORM', 'EXPORTED', name='status', create_type=False), nullable=False),
    sa.Column('boundary_status', postgresql.ENUM('FOR_REVIEW', 'FOR_PLATFORM', 'NOT_FOR_PLATFORM', 'EXPORTED', name='status', create_type=False), nullable=True),
    sa.Column('reference', sa.Text(), nullable=False),
    sa.Column('name', sa.Text(), nullable=True),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('entry_date', sa.Date(), nullable=False),
    ...
    sa.Column('organisation', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['local_plan_document_reference'], ['local_plan_document.reference'], ),
    sa.ForeignKeyConstraint(['organisation'], ['organisation.organisation'], ),
    sa.PrimaryKeyConstraint('local_plan_document_reference', 'organisation')
    )
    op.create_table('local_plan_event',
    sa.Column('event_category', postgresql.ENUM('TIMETABLE_PUBLISHED', 'ESTIMATED_REGULATION_18', 'ESTIMATED_REGULATION_19', 'ESTIMATED_EXAMINATION_AND_ADOPTION', 'REGULATION_18', 'REGULATION_19', 'PLANNING_INSPECTORATE_EXAMINATION', 'PLANNING_INSPECTORATE_FINDINGS', name='eventcategory', create_type=False), nullable=False),
...
def downgrade():
    ...
    sa.Enum('FOR_REVIEW', 'FOR_PLATFORM', 'NOT_FOR_PLATFORM', 'EXPORTED', name='status').drop(op.get_bind())
    sa.Enum('TIMETABLE_PUBLISHED', 'ESTIMATED_REGULATION_18', 'ESTIMATED_REGULATION_19', 'ESTIMATED_EXAMINATION_AND_ADOPTION', 'REGULATION_18', 'REGULATION_19', 'PLANNING_INSPECTORATE_EXAMINATION', 'PLANNING_INSPECTORATE_FINDINGS', name='eventcategory').drop(op.get_bind())
    # ### end Alembic commands ###
