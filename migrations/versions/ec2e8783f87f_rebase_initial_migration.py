"""rebase initial migration

Revision ID: ec2e8783f87f
Revises:
Create Date: 2024-09-24 09:28:42.077961
...
def upgrade():
    ...
    sa.Enum('DRAFT', 'READY_FOR_PUBLICATION', 'PUBLISHED', name='publicationstatus').create(op.get_bind())
    ...
    sa.Column('publication_status', postgresql.ENUM('DRAFT', 'READY_FOR_PUBLICATION', 'PUBLISHED', name='publicationstatus', create_type=False), nullable=False),
    sa.Column('reference', sa.Text(), nullable=False),
    sa.Column('name', sa.Text(), nullable=True),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('entry_date', sa.Date(), nullable=False),
...
def downgrade():
    ...
    sa.Enum('DRAFT', 'READY_FOR_PUBLICATION', 'PUBLISHED', name='publicationstatus').drop(op.get_bind())
    # ### end Alembic commands ###
